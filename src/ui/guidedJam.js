...
export const GUIDED_STEPS = [
  {
    ...
    titleJa: '最初のサウンドを選ぶ',
    bodyJa: '音色と使う音の組み合わせが変わります。間違った選択はありません。',
    done: (s) => s.kitChosen,
  },
  {
    id: 'foundation',
    ...
    titleJa: '土台を用意する',
    bodyJa: 'その上で演奏できる土台です。プリセットを使っても、無音から始めても構いません。',
  ...
  },
  {
    ...
    titleJa: '8〜24回、キーを打つ',
    bodyJa: '自由にタイプしてください。すべてのキーが楽器になり、押す長さが音の表情になります。',
  ...
  },
  {
    ...
    titleJa: 'ループにする',
    bodyJa: 'Enterを押すと、今弾いた音が繰り返され、その上に新しい音を重ねられます。',
  ...
  },
  {
    ...
    titleJa: '違う役割を重ねる',
    bodyJa: '最初とは違うループを追加します。より低く、少なく、または反対の手で。',
    done: (s) => s.tracks >= 2,
  },
  {
    id: 'shape',
    ...
    titleJa: '曲に展開を作る',
    bodyJa: 'ミックスをセクションとして保存し、順番に切り替えて曲を演奏します。',
    done: (s) => s.sections >= 2,
  },
  {
    id: 'capture',
    ...
    titleJa: '演奏を録音する',
    bodyJa: 'すべての打鍵と操作を録音し、リプレイや音声の書き出しに使います。',
    done: (s) => s.captured,
  },
];
